...
/***/ 194:
/*!***********************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/网易云/music-uni/main.js?{"page":"pages%2Fsearch%2Fsearch"} ***!
  \***********************************************************************************************/
...
/***/ 195:
/*!****************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/网易云/music-uni/pages/search/search.vue ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ 196:
/*!***********************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/网易云/music-uni/pages/search/search.vue?vue&type=template&id=4cedc0c6& ***!
  \***********************************************************************************************************/
...
/***/ 197:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Administrator/Desktop/网易云/music-uni/pages/search/search.vue?vue&type=template&id=4cedc0c6& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 198:
/*!*****************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/网易云/music-uni/pages/search/search.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 199:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Administrator/Desktop/网易云/music-uni/pages/search/search.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _search = __webpack_require__(/*! ../../service/search.js */ 200);
...
//
//
var _default = { data: function data() {return { seach: true, hotSearch: [], moreSearch: true, searchSong: [], keywords: '', isSearchSongs: false };}, onLoad: function onLoad() {this._getSearch();}, methods: { // ---------------------事件监听--------------------------
    inp: function inp() {if (this.keywords.trim().length == 0) {this.searchSong = [];this.isSearchSongs = false;}}, handleBack: function handleBack() {uni.navigateBack({ delta: 1 });}, handlePlayALl: function handlePlayALl() {var musicId = this.searchSong[0].id;for (var i = 0; i < this.searchSong.length; i++) {_App.default.globalData.waitForPlaying.push(this.searchSong[i].id);}var index = _App.default.globalData.waitForPlaying.indexOf(musicId);_App.default.globalData.waitForPlaying.splice(index, 1);uni.navigateTo({ url: "/pages/play/play?music=".concat(musicId) });}, handleMoreSearch: function handleMoreSearch() {this.moreSearch = !this.moreSearch;}, handleSearch: function handleSearch() {if (this.keywords.trim().length == 0) {uni.showToast({ title: '还没输入关键词', icon: 'none' });return;}uni.showToast({ icon: 'loading', title: '拼命加载中...' });this.seach = false;this.hotSearch = [];this.moreSearch = false;this._getSearchKeywords(this.keywords);this.isSearchSongs = true;}, handleSongs: function handleSongs(e) {// console.log(e.currentTarget.dataset.id)
      var musicId = e.currentTarget.dataset.id;for (var i = 0; i < this.searchSong.length; i++) {_App.default.globalData.waitForPlaying.push(this.searchSong[i].id);}var index = _App.default.globalData.waitForPlaying.indexOf(musicId);_App.default.globalData.waitForPlaying.splice(index, 1);uni.navigateTo({ url: "/pages/play/play?music=".concat(musicId) });}, // ---------------------网络请求--------------------------
    _getSearch: function _getSearch() {var _this = this;(0, _search.getSearch)().then(function (res) {_this.hotSearch = res.data.data; // console.log(this.hotSearch)
      });}, _getSearchKeywords: function _getSearchKeywords(keywords) {var _this2 = this;(0, _search.getSearchKeywords)(keywords).then(function (res) {_this2.searchSong = res.data.result.songs;console.log(_this2.searchSong);});} } };exports.default = _default;
...
/***/ 201:
/*!*************************************************************************************************************!*\
  !*** C:/Users/Administrator/Desktop/网易云/music-uni/pages/search/search.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 202:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Administrator/Desktop/网易云/music-uni/pages/search/search.vue?vue&type=style&index=0&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
